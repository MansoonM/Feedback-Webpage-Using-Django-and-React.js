...
SECRET_KEY = 'django-insecure-jqb4izwoke&ymek(l15dbzs%*&j&*)lzwf%)5e@vu!$&(k(d^a'
...
# CORS (allow frontend dev server)      ADD
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
]

# REST Framework basic config    ADD
REST_FRAMEWORK = {
